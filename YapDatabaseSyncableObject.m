#import "YapDatabaseSyncableObject.h"
#import <objc/runtime.h>


@implementation YapDatabaseSyncableObject {
@private
...
- (id)copyWithZone:(NSZone *)zone
{
	...
	YapDatabaseSyncableObject *copy = [[[self class] alloc] init];
	copy->isImmutable = NO;
...
+ (NSMutableSet *)monitoredProperties
{
	...
	Class rootClass = [YapDatabaseSyncableObject class];
